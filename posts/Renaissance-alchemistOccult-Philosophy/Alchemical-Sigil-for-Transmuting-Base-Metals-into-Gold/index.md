...
2. Encircling the Ouroboros are seven concentric circles, each one associated with one of the seven classical planets – namely, the Sun, Moon, Mars, Mercury, Jupiter, Venus, and Saturn. Each circle contains the alchemical symbol for the corresponding metal that the planet rules, i.e., gold, silver, iron, mercury, tin, copper, and lead, respectively.
